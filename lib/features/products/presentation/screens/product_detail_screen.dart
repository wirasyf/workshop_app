  ...
  Future<void> _confirmDelete(
    ...
    final confirm = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text(
          'Apakah Anda yakin ingin menghapus "${product.name}" beserta data stoknya? Tindakan ini tidak dapat dibatalkan.',
        ),
        actions: [
          TextButton(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildInfoSection(theme, 'Harga', [
                    ...
                    _infoRow(
                      'Harga Grosir',
                      product.sellPriceWholesale != null
                    ...
                    children: [
                      Expanded(
                        child: OutlinedButton.icon(
                          onPressed: () => context.go(
                            '/products/$productId/adjust${from == 'dashboard' ? '?from=dashboard' : ''}',
                          ),
                      ...
                      Expanded(
                        child: ElevatedButton.icon(
                          onPressed: () => context.go(
                            '/products/$productId/edit${from == 'dashboard' ? '?from=dashboard' : ''}',
                          ),
                  ...
                  SizedBox(
                    ...
                    child: TextButton.icon(
                      onPressed: () =>
                          _confirmDelete(context, ref, product, from),
                      icon: const Icon(
