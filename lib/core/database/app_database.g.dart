...
class Supplier extends DataClass implements Insertable<Supplier> {
  ...
  @override
  int get hashCode => Object.hash(id, name, contactName, phone, address, notes);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Supplier &&
...
class $ProductSuppliersTable extends ProductSuppliers
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<ProductSupplier> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
...
class ProductSupplier extends DataClass implements Insertable<ProductSupplier> {
  ...
  ProductSuppliersCompanion toCompanion(bool nullToAbsent) {
    return ProductSuppliersCompanion(
      ...
      lastCost: lastCost == null && nullToAbsent
          ? const Value.absent()
          : Value(lastCost),
  ...
  ProductSupplier copyWith({
    ...
    lastCost: lastCost.present ? lastCost.value : this.lastCost,
  ...
  @override
  int get hashCode =>
      Object.hash(id, productId, supplierId, lastCost, isPrimary);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class Customer extends DataClass implements Insertable<Customer> {
  ...
  @override
  int get hashCode => Object.hash(id, name, phone, address, loyaltyPoints);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Customer &&
...
class $PoItemsTable extends PoItems with TableInfo<$PoItemsTable, PoItem> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  PoItem map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return PoItem(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
...
class PoItem extends DataClass implements Insertable<PoItem> {
  final int id;
  final int poId;
  final int productId;
  ...
  PoItem copyWithCompanion(PoItemsCompanion data) {
    return PoItem(
      id: data.id.present ? data.id.value : this.id,
  ...
  @override
  int get hashCode =>
      Object.hash(id, poId, productId, qtyOrdered, qtyReceived, costPrice);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is PoItem &&
...
class PoItemsCompanion extends UpdateCompanion<PoItem> {
  final Value<int> id;
  ...
  PoItemsCompanion.insert({
    ...
    required double costPrice,
       ...
       qtyOrdered = Value(qtyOrdered),
       costPrice = Value(costPrice);
  static Insertable<PoItem> custom({
    Expression<int>? id,
    Expression<int>? poId,
    Expression<int>? productId,
...
class ReturnItem extends DataClass implements Insertable<ReturnItem> {
  ...
  @override
  int get hashCode => Object.hash(id, returnId, productId, qty, unitPrice);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is ReturnItem &&
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $ProductSuppliersTable productSuppliers = $ProductSuppliersTable(
    this,
  );
...
final class $$UsersTableReferences
  ...
  _purchaseOrdersRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.purchaseOrders,
    aliasName: $_aliasNameGenerator(db.users.id, db.purchaseOrders.createdBy),
  );
...
final class $$ProductsTableReferences
  ...
  _productSuppliersRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.productSuppliers,
    aliasName: $_aliasNameGenerator(
      db.products.id,
      db.productSuppliers.productId,
    ),
  );

  $$ProductSuppliersTableProcessedTableManager get productSuppliersRefs {
    final manager = $$ProductSuppliersTableTableManager(
      $_db,
      $_db.productSuppliers,
    ).filter((f) => f.productId.id.sqlEquals($_itemColumn<int>('id')!));

    final cache = $_typedResult.readTableOrNull(
      _productSuppliersRefsTable($_db),
    );
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: cache),
    );
  ...
  static MultiTypedResultKey<$PoItemsTable, List<PoItem>> _poItemsRefsTable(
    _$AppDatabase db,
  ) => MultiTypedResultKey.fromTable(
    db.poItems,
    aliasName: $_aliasNameGenerator(db.products.id, db.poItems.productId),
  );
...
final class $$SuppliersTableReferences
  ...
  _productSuppliersRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    ...
    aliasName: $_aliasNameGenerator(
      db.suppliers.id,
      db.productSuppliers.supplierId,
    ),
  );
    ...
    : super(
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback:
              ({productSuppliersRefs = false, purchaseOrdersRefs = false}) {
                return PrefetchHooks(
                  db: db,
                  explicitlyWatchedTables: [
                    if (productSuppliersRefs) db.productSuppliers,
...
final class $$ProductSuppliersTableReferences
    extends
        BaseReferences<_$AppDatabase, $ProductSuppliersTable, ProductSupplier> {
  ...
  static $SuppliersTable _supplierIdTable(_$AppDatabase db) =>
      db.suppliers.createAlias(
        $_aliasNameGenerator(db.productSuppliers.supplierId, db.suppliers.id),
      );
...
class $$ProductSuppliersTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
...
typedef $$ProductSuppliersTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $ProductSuppliersTable,
      ProductSupplier,
...
final class $$PurchaseOrdersTableReferences
  ...
  static MultiTypedResultKey<$PoItemsTable, List<PoItem>> _poItemsRefsTable(
    ...
    db.poItems,
    aliasName: $_aliasNameGenerator(db.purchaseOrders.id, db.poItems.poId),
  );
    ...
    $PurchaseOrdersTable table,
        ...
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback:
              ({supplierId = false, createdBy = false, poItemsRefs = false}) {
                return PrefetchHooks(
                  db: db,
...
final class $$PoItemsTableReferences
    extends BaseReferences<_$AppDatabase, $PoItemsTable, PoItem> {
  ...
  static $PurchaseOrdersTable _poIdTable(_$AppDatabase db) => db.purchaseOrders
      .createAlias($_aliasNameGenerator(db.poItems.poId, db.purchaseOrders.id));
  ...
  static $ProductsTable _productIdTable(_$AppDatabase db) => db.products
      .createAlias($_aliasNameGenerator(db.poItems.productId, db.products.id));
...
final class $$ReturnsTableReferences
  ...
  static $UsersTable _userIdTable(_$AppDatabase db) => db.users.createAlias(
    $_aliasNameGenerator(db.returns.userId, db.users.id),
  );
